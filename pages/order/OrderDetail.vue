	...
	<view>
		...
		<navigator url="/pages/address/address?source=1" class="address-section">
			<view class="order-content">
				...
				<view class="cen">
					...
					<text class="address">{{addressData.title}} {{addressData.detail}}</text>
				</view>
			</view>
		...
		<view class="goods-section">
			<view class="g-header b-b">
				...
				<text class="name">{{orderInfo.title}}</text>
			</view>
			<!-- 商品列表 -->
			<view class="g-item" v-for="item in orderDetailList" :key="item.id">
		...
		<view class="yt-list">
			<view class="yt-list-cell b-b">
				...
				<text class="cell-tip">￥{{orderInfo.amount}}</text>
			</view>
			<view class="yt-list-cell b-b">
			...
			<view class="yt-list-cell desc-cell">
				...
				<text class="cell-tip">{{orderInfo.desc}}</text>
			</view>
		</view>
		...
		<view class="footer">
			...
			<text class="submit" @click="back">返回</text>
		</view>
	</view>
</template>
