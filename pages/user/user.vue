    ...
    <view class="container">  
		...
		<view class="user-section">
			...
			<view class="user-info-box">
				...
				<view class="info-box">
					<view><text class="username">{{userInfo.userName || '游客'}}</text></view>
					<view style="margin-left: 20upx;font-size: 24upx;text-indent:2em;">
						<text>{{userInfo.individualitySignature}}</text>
					</view>
				</view>
			</view>
